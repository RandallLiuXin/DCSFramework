        ...
        private sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public override int Capacity
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        throw new GalaxyException("Capacity is invalid.");
                    }
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    if (value < 0f)
                    {
                        throw new GalaxyException("ExpireTime is invalid.");
                    }
            ...
            public void Register(T obj, bool spawned)
            {
                if (obj == null)
                {
                    throw new GalaxyException("Object is invalid.");
                }
            ...
            public void Unspawn(object target)
            {
                if (target == null)
                {
                    throw new GalaxyException("Target is invalid.");
                }
                ...
                {
                    throw new GalaxyException(Utility.Text.Format("Can not find target in object pool '{0}'.", Utility.Text.GetFullName<T>(Name)));
                }
            }
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                ...
                {
                    throw new GalaxyException("Release object filter callback is invalid.");
                }
            ...
            private List<Object<T>> GetObjects(string name)
            {
                if (name == null)
                {
                    throw new GalaxyException("Name is invalid.");
                }
            ...
            private void ReleaseObject(T obj)
            {
                ...
                throw new GalaxyException("Can not release object which is not found.");
            }
