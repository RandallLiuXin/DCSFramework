...
namespace Galaxy.Fsm
{
    ...
    /// 游戏状态机初始化参数。
    /// </summary>
    public abstract class FsmEnterParams : IReference
    {
        public FsmEnterParams()
        {
        }
    ...
    /// 游戏状态机事件。
    /// </summary>
    public abstract class FsmEventParams : IReference
    {
        public FsmEventParams()
        {
        }
    ...
    public interface IFsm<T> where T : class
    {
        ...
        void Start<TState>(FsmEnterParams enterParams = null) where TState : FsmState<T>;
        ...
        /// <param name="enterParams">初始化参数。</param>
        void Start(Type stateType, FsmEnterParams enterParams = null);
        ...
        Dictionary<string, Variable> GetAllData();
        ...
        /// <param name="enterParams">初始化参数。</param>
        void ChangeState<TState>(FsmEnterParams enterParams = null) where TState : FsmState<T>;
        ...
        /// <param name="enterParams">初始化参数。</param>
        void ChangeState(Type stateType, FsmEnterParams enterParams = null);
    }
}
