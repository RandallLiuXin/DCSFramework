...
namespace Galaxy.Task
{
    ...
    /// 任务管理器。
    /// </summary>
    internal sealed class TaskManager : GalaxyModule, ITaskManager
    {
        ...
        internal override void Update(float elapseSeconds)
        {
            ...
            while (current != null)
            {
                ...
                {
                    throw new GalaxyException("Task status is invalid.");
                }
        ...
        public bool CancelTask(TaskBase task)
        {
            if (task == null)
            {
                throw new GalaxyException("Task is invalid.");
            }
