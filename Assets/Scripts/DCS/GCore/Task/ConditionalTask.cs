...
namespace Galaxy.Task
{
    ...
    public sealed class ConditionalTask : TaskBase
    {
        ...
        private GalaxyAction<ConditionalTask, string> m_CompleteAction;
        private GalaxyAction<ConditionalTask, string> m_FailureAction;
        private GalaxyAction<ConditionalTask, string> m_CancelAction;
        ...
        public void SetCompleteAction(GalaxyAction<ConditionalTask, string> completeAction)
        {
        ...
        public void SetFailureAction(GalaxyAction<ConditionalTask, string> failureAction)
        {
        ...
        public void SetCancelAction(GalaxyAction<ConditionalTask, string> cancelAction)
        {
        ...
        protected internal override void OnUpdate(float elapseSeconds)
        {
