...
namespace Galaxy.Procedure
{
    ...
    /// 流程管理器。
    /// </summary>
    internal sealed class ProcedureManager : GalaxyModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                ...
                {
                    throw new GalaxyException("You must initialize procedure first.");
                }
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            if (fsmManager == null)
            {
                throw new GalaxyException("FSM manager is invalid.");
            }
