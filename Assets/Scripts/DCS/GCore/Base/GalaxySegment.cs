namespace Galaxy
{
    ...
    public struct GalaxySegment<T> where T : class
    {
        ...
        public GalaxySegment(T source, int offset, int length)
        {
            if (source == null)
            {
                throw new GalaxyException("Source is invalid.");
            }
        ...
        {
            return obj is GalaxySegment<T> && Equals((GalaxySegment<T>)obj);
        }
        ...
        /// <param name="obj">要比较的对象。</param>
        /// <returns>被比较的对象是否与自身相等。</returns>
        public bool Equals(GalaxySegment<T> obj)
        {
        ...
        public static bool operator ==(GalaxySegment<T> a, GalaxySegment<T> b)
        {
            return a.Equals(b);
        }
