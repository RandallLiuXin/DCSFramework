...
namespace Galaxy
{
    ...
    public static partial class ReferencePool
    {
        ...
        public static void Release<T>(T reference) where T : class, IReference
        {
            if (reference == null)
            {
                throw new GalaxyException("Reference is invalid.");
            }
        ...
        private static void InternalCheckReferenceType(Type referenceType)
        {
            ...
            {
                throw new GalaxyException("Reference type is invalid.");
            }

            if (!referenceType.IsClass || referenceType.IsAbstract)
            {
                throw new GalaxyException("Reference type is not a non-abstract class type.");
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new GalaxyException(Utility.Text.Format("Reference type '{0}' is invalid.", referenceType.FullName));
            }
        }
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            if (referenceType == null)
            {
                throw new GalaxyException("ReferenceType is invalid.");
            }
