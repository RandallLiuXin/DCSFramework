...
namespace Galaxy.Setting
{
    /// <summary>
    /// 配置管理器。
    /// </summary>
    internal sealed class SettingManager : GalaxyModule, ISettingManager
    {
        ...
        public void SetSettingHelper(ISettingHelper settingHelper)
        {
            ...
            {
                throw new GalaxyException("Setting helper is invalid.");
            }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            {
                throw new GalaxyException("Setting name is invalid.");
            }
